...
object MadeInBrazilDatabase {
    ...
    @Database(entities = [Users::class,Result::class,ResultSearch::class, CustomList::class, ListSerieItem::class, ListMovieItem::class, ListMovieCrossRef::class, ListSerieCrossRef::class], version = 2,exportSchema = false)
